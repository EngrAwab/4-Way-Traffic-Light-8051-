...
# 33 "newmain.c"
unsigned int LED_STATUS[] = {1, 1, 0, 1, 1, 0, 1, 1, 0, 0, 1, 1};
...
void LED() {
RE2 = (__bit)LED_STATUS[0];
RE1 = (__bit)LED_STATUS[1];
RE0 = ~(__bit)LED_STATUS[2];

RC5 = (__bit)LED_STATUS[3];
RC4 = (__bit)LED_STATUS[4];
RC3 = ~(__bit)LED_STATUS[5];

RA1 = (__bit)LED_STATUS[6];
RA4 = (__bit)LED_STATUS[7];
RA5 = ~(__bit)LED_STATUS[8];

RC7 = (__bit)LED_STATUS[9];
RC1 = (__bit)LED_STATUS[10];
RC6 = ~(__bit)LED_STATUS[11];
